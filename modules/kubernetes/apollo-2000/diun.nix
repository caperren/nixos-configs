              ...
              containers = [
                {
                  ...
                  env = [
                    ...
                    }
                    {
                      ...
                      value = "Found updated image {{ .Entry.Image.Path }}.%0A<code>nix-shell -p nix-prefetch-docker --run \"nix-prefetch-docker --image-name {{ .Entry.Image }} --image-tag {{ .Entry.Image.Tag }}\"</code>";
                    }
                    {
