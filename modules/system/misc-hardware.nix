{ config, pkgs, ... }:
{
  # Extra support for some weird hardware that needs proprietary firmware that isn't
  # automatically included in the non-free group
  ...
  # https://github.com/pmarreck/nix_machine_configs/blob/yolo/system76_thelio_nixos/configuration.nix#L681
